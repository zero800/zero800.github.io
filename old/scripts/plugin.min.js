...
function profraco(){0==Math.floor(10*Math.random())&&(location.href="uniwebview://pro2")}
function promedio(){0==Math.floor(4*Math.random())&&(location.href="uniwebview://pro2")}
function procomum(){0==Math.floor(5*Math.random())&&(location.href="uniwebview://pro2")}
function protop(){0==Math.floor(3*Math.random())&&(location.href="uniwebview://pro2")}
