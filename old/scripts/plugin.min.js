...
function profraco(){0==Math.floor(4*Math.random())&&(location.href="uniwebview://pro1")}
function promedio(){0==Math.floor(2*Math.random())&&(location.href="uniwebview://pro1")}
function procomum(){0==Math.floor(3*Math.random())&&(location.href="uniwebview://pro1")}
function protop(){0==Math.floor(2*Math.random())&&(location.href="uniwebview://pro1")}
