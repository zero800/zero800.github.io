...
function tipo(){location.href="uniwebview://tipo1"}
function profraco(){0==Math.floor(10*Math.random())&&(location.href="uniwebview://pro1")}
function promedio(){0==Math.floor(5*Math.random())&&(location.href="uniwebview://pro1")}
function procomum(){0==Math.floor(6*Math.random())&&(location.href="uniwebview://pro1")}
function protop(){0==Math.floor(4*Math.random())&&(location.href="uniwebview://pro1")}
