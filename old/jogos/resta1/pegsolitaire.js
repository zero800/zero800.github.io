(function(global){
    ...
    function getBoardCatalog(){
        return [
            {id:"English", ctor:createEnglishBoard, title:"Inglês (33 casas)"},
            {id:"European", ctor:createEuropeanBoard, title:"Europeu (37 casas)"},
            {id:"Triangular5", ctor:createTriangular5Board, title:"Triangular5 (15 casas)"},
            {id:"Hexagonal5", ctor:createHexagonal5Board, title:"Hexagonal5 (61 casas)"},
            {id:"Propeller", ctor:createPropellerBoard, title:"Hélice (16 casas)"},
            {id:"Minimum", ctor:createMinimumBoard, title:"Mínimo (3 casas)"},
            {id:"4Holes", ctor:create4HolesBoard, title:"4 Casas (4 casas)"},
            {id:"5Holes", ctor:create5HolesBoard, title:"5 Casas (5 casas)"},
            {id:"Easy Pinwheel", str:"R 4 4 __P_OPP__PPP_P__", title:"Cata-Vento (8 casas)"},
            {id:"Banzai7", str:"H 3 3 OPOPP__PP", title:"Banzai 7 (7 casas)"},
            {id:"Megaphone", str:"H 4 4 _P__PPPP__PP__O_", title:"Megafone (8 casas)"},
            {id:"Owl", str:"H 4 4 _PPPPOOP_PPP_PP_", title:"Coruja (12 casas)"},
            {id:"Star", str:"H 4 5 __O_PPPP_PPPPPPP__P_", title:"Estrela (13 casas)"},
            {id:"Arrow9", str:"H 4 4 __P_OPP__PPP_PP_", title:"Seta 9 (9 casas)"}
        ];
    };
    ...
    function createGameBox(opt)
    {
        ...
        if(!opt.disableNewGame){
            newButton(controlDiv, "Novo Jogo", newGame);
        }
        
		if(!opt.disableUndo){
            newButton(controlDiv, "Voltar", undo);
        }
		
		
       // if(!opt.disableEdit){
       //     newButton(controlDiv, "Editar", edit);
       // }
        ...
        function updateStatus(){
            if(currentCanvas){
                spanMoves.innerHTML = "<font color='#0CF'>► </font>" + currentCanvas.pegsolitaire.history.getMoveCount();
                ...
                spanGameState.innerHTML =
                    ...
                    board.isSolved() ? "<font color='#0E0'>Você Ganhou!</font>" :
                    board.isEnd() ? "<font color='#E00'>Fim de Jogo!</font>" :
                    "";
            }
        }
